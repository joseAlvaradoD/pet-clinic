package jjad.springframework.petclinic.controllers;
...
import jjad.springframework.petclinic.services.PetService;
import jjad.springframework.petclinic.services.VisitService;
    ...
    void setUp() {
        ...
        when(petService.findById(anyLong()))
                .thenReturn(
                        Pet.builder()
                            .id(petId)
                            .birthDate(LocalDate.of(2024,01,01))
                            .name("Cutie")
                            .visits(new HashSet<>())
                            .owner(Owner.builder()
                                .id(ownerId)
